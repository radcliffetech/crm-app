type StudentFormProps = {
  ...
  export function StudentForm({ formData, setFormData, onSubmit, editingstudent_id, onCancel }: StudentFormProps) {
    return (
      <div className="relative mb-6 p-6 bg-gray-50 shadow-md rounded-md">
        <div className="flex justify-between items-start mb-4">
          <h3 className="text-xl font-semibold">
            {editingstudent_id ? `Edit ${formData.name_first} ${formData.name_last}` : "Create New Student"}
          </h3>
          <button
            type="button"
            onClick={onCancel}
